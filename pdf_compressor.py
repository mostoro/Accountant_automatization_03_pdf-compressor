...
def get_ghostscript_path():
    gs_names = ['gs', 'gswin32', 'gswin64', 'gswin64c'] 
...
# from Theeko74_pdf_compressor import compress
import os


#function to compress
def compress_pdf(file):
    compress(file, '{}_compressed.pdf'.format(file), power=3)
 
# assign directory
#directory = r'G:\My Drive\MOSTORO\Others\Python\pdf compressor\uncompressed'


directory = input('Type the path of the folder containing the files to be compressed')
